...
err_311  = '("Error with the parameters file.",/,      &
           & "Item ",A,",",/,                                    &
           & "for the zone # ",i3,", index of cross-section is out of range.")'
character (*), parameter ::                                                &
err_311c = '("Item ",A,                                                  &
           & ", index of cross-section out of range for the zone # ",i3)'
!-------------------------------------------------------------------------
character (*), parameter ::                                                &
...
!-------------------------------------------------------------------------
CHARACTER (*), PARAMETER :: &
ERR_800 = '("Error with the parameters file.", /, &
          "Item ", A, /, &
          "Longitudinal discretization for reach No.", I3, " is missing.")'
CHARACTER (*), PARAMETER :: &
ERR_800C = '("Item ", A, ". " &
           "Longitudinal discretization for reach No.", I3, " is missing.")'
!-------------------------------------------------------------------------
CHARACTER (*), PARAMETER :: &
ERR_801 = '("Error with the parameters file.", /, &
          "Item ", A, /, &
          "Boundary cross-section for reach No.", I3, " in longitudinal discretization is missing.")'
CHARACTER (*), PARAMETER :: &
ERR_801C = '("Item ", A, ". " &
           "Boundary cross-section for reach No.", I3, " in longitudinal discretization is missing.")'
!-------------------------------------------------------------------------
CHARACTER (*), PARAMETER :: &
ERR_802 = '("Error with the parameters file.", /, &
          "Item ", A, /, &
          "Reach index of No.", I3, " is out of range.")'
CHARACTER (*), PARAMETER :: &
ERR_802C = '("Item ", A, ". " &
           "Reach index of No.", I3, " is out of range.")'
!-------------------------------------------------------------------------
CHARACTER (*), PARAMETER :: &
ERR_803 = '("Error with the parameters file.", /, &
          "Item ", A, /, &
          "Wrong sequence of reach for zone No.", I3, " and zone No.", I3, " in longitudinal discretization.")'
CHARACTER (*), PARAMETER :: &
ERR_803C = '("Item ", A, ". " &
           "Wrong sequence of reach for zone No.", I3, " and zone No.", I3, " in longitudinal discretization.")'
!-------------------------------------------------------------------------
CHARACTER (*), PARAMETER :: &
ERR_804 = '("Error with the parameters file.", /, &
          "Item ", A, /, &
          "Wrong connection for zone No.", I3, " and zone No.", I3, " in longitudinal discretization.")'
CHARACTER (*), PARAMETER :: &
ERR_804C = '("Item ", A, ". " &
           "Wrong connection for zone No.", I3, " and zone No.", I3, " in longitudinal discretization.")'
!-------------------------------------------------------------------------
CHARACTER (*), PARAMETER :: &
ERR_805 = '("Error with the parameters file.", /, &
           "Item ", A, /, &
           "Cross-section No.1 is missing for zone No.1.")'
CHARACTER (*), PARAMETER :: &
ERR_805C = '("Item ", A, ". " &
            "Cross-section No.1 is missing for zone No.1.")'
